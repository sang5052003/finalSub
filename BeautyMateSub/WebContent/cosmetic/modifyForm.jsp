                         ...
                         <option value="essence">에센스</option>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-10 col-sm-9">
                              <input name="brand" type="text" value="${cosmetic.brand}" class="form-control" id="" placeholder="">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="" class="col-md-2 col-sm-3 control-label">제품명</label>
                            <div class="col-md-10 col-sm-9">
                              <input name="cosmeticName" type="text" value="${cosmetic.cosmeticName}" class="form-control" id="" placeholder="">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="" class="col-md-2 col-sm-3 control-label">용량</label>
                            <div class="col-md-10 col-sm-9">
                              <input name="volume" type="text" value="${cosmetic.volume}" class="form-control" id="" placeholder="">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="" class="col-md-2 col-sm-3 control-label">가격</label>
                            <div class="col-md-10 col-sm-9">
                              <input name="cost" type="text" value="${cosmetic.cost}" class="form-control" id="" placeholder="">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="" class="col-md-2 col-sm-3 control-label">이미지 주소</label>
                            <div class="col-md-10 col-sm-9">
                              <input name="img" type="text" value="${cosmetic.img}" class="form-control" id="" placeholder="">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="" class="col-md-2 col-sm-3 control-label">성분</label>
                            <div class="col-md-10 col-sm-9">
                                <textarea class="form-control" name="ingredients" rows="13" cols="50">${cosmetic.ingredients}</textarea>
                            </div>
                          </div>
