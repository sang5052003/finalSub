                                            ...
                                            <div id="collapse7" class="collapseItem collapse" aria-expanded="false" style="height: 0px;">
                                                <div class="collapse-inner">
                                                    <div>
                                                        <table>
                                                            <tr>
                                                                <td><img id="recommendedIngredientImg1" src="" alt="Recommended Ingredient" class="img-responsive" width="100" height="100">
                                                                    <input id="rii1" name="rii1" value="" style="border: none; border-right: 0px; border-top: 0px; boder-left: 0px; boder-bottom: 0px; readonly: true;">
                                                                </td>
                                                                <td><img id="recommendedIngredientImg2" src="" alt="Recommended Ingredient" class="img-responsive" width="100" height="100">
                                                                    <input id="rii2" name="rii2" value="" style="border: none; border-right: 0px; border-top: 0px; boder-left: 0px; boder-bottom: 0px; readonly: true;">
                                                                </td>
                                                                <td><img id="recommendedIngredientImg3" src="" alt="Recommended Ingredient" class="img-responsive" width="100" height="100">
                                                                    <input id="rii3" name="rii3" value="" style="border: none; border-right: 0px; border-top: 0px; boder-left: 0px; boder-bottom: 0px; readonly: true;">
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                            ...
                                            <div id="collapse8" class="collapseItem collapse" aria-expanded="false" style="height: 0px;">
                                                <div class="collapse-inner">
                                                    <div>
                                                        <table>
                                                            <tr>
                                                                <td><img id="bannedIngredientImg1" src="" alt="Image Blog" class="img-responsive" width="100" height="100">
                                                                    <input id="bii1" name="bii1" value="" style="border: none; border-right: 0px; border-top: 0px; boder-left: 0px; boder-bottom: 0px; readonly: true;">
                                                                </td>
                                                                <td><img id="bannedIngredientImg2" src="" alt="Image Blog" class="img-responsive" width="100" height="100">
                                                                    <input id="bii2" name="bii2" value="" style="border: none; border-right: 0px; border-top: 0px; boder-left: 0px; boder-bottom: 0px; readonly: true;">
                                                                </td>
                                                                <td><img id="bannedIngredientImg3" src="" alt="Image Blog" class="img-responsive" width="100" height="100">
                                                                    <input id="bii3" name="bii3" value="" style="border: none; border-right: 0px; border-top: 0px; boder-left: 0px; boder-bottom: 0px; readonly: true;">
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                            ...
                                            <div id="collapse9" class="collapseItem collapse" aria-expanded="false" style="height: 0px;">
                                                <div class="collapse-inner">
                                                    <div>
                                                        <table>
                                                            <tr>
                                                                <td><img id="recommendedFoodImg1" src="" alt="Image Blog" class="img-responsive" width="100" height="100">
                                                                    <input id="rfi1" name="rfi1" value="" style="border: none; border-right: 0px; border-top: 0px; boder-left: 0px; boder-bottom: 0px; readonly: true;">
                                                                </td>
                                                                <td><img id="recommendedFoodImg2" src="" alt="Image Blog" class="img-responsive" width="100" height="100">
                                                                    <input id="rfi2" name="rfi2" value="" style="border: none; border-right: 0px; border-top: 0px; boder-left: 0px; boder-bottom: 0px; readonly: true;">
                                                                </td>
                                                                <td><img id="recommendedFoodImg3" src="" alt="Image Blog" class="img-responsive" width="100" height="100">
                                                                    <input id="rfi3" name="rfi3" value="" style="border: none; border-right: 0px; border-top: 0px; boder-left: 0px; boder-bottom: 0px; readonly: true;">
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </div>
