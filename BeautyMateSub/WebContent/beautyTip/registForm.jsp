...
<body class="body-wrapper static">
			...
			<div class="row">
				<div class="col-xs-12">
					<div class="innerWrapper">
						<div class="orderBox  patternbg">등록</div>
						<div class="profile">
									...
									<form action="${ctx }/beautyTip/regist.do" method="post"
										...
										<div class="myFormGroup" name="form-groupName">
											...
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-7">
													<textarea cols="0" rows="0" name="beautyTipContent0"  class="form-control"></textarea>
												</div>
											</div>
										</div>
	...
	/* 		<div class="form-group">
		...
		<div class="form-group">
			<label for="" class="col-md-2 col-sm-3 control-label">내용</label>
			<div class="col-md-8 col-sm-7">
				<textarea cols="0" rows="0" name="beautyTipContent"  class="form-control"></textarea>
			</div>
		</div> */
